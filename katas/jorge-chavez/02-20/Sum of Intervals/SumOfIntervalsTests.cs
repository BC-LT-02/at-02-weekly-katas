...
public class IntervalTest
{
    ...
    public void ShouldAddDisjoinedIntervals()
    {
        ...
        Assert.AreEqual(
            78,
            Intervals.SumIntervals(new Interval[] { (-245, -218), (-194, -179), (-155, -119) })
        );
    }
    ...
    public void ShouldAddOverlappingIntervals()
    {
        ...
        Assert.AreEqual(
            19,
            Intervals.SumIntervals(new Interval[] { (1, 5), (10, 20), (1, 6), (16, 19), (5, 11) })
        );
    }
    ...
    public void ShouldHandleMixedIntervals()
    {
        Assert.AreEqual(
            13,
            Intervals.SumIntervals(new Interval[] { (2, 5), (-1, 2), (-40, -35), (6, 8) })
        );
        Assert.AreEqual(
            1234,
            Intervals.SumIntervals(
                new Interval[] { (-7, 8), (-2, 10), (5, 15), (2000, 3150), (-5400, -5338) }
            )
        );
        Assert.AreEqual(
            158,
            Intervals.SumIntervals(
                new Interval[] { (-101, 24), (-35, 27), (27, 53), (-105, 20), (-36, 26) }
            )
        );
    }
    ...
    public void ShouldHandleLargeIntervals()
    {
        Assert.AreEqual(
            2_000_000_000,
            Intervals.SumIntervals(new Interval[] { (-1_000_000_000, 1_000_000_000) })
        );
        Assert.AreEqual(
            100_000_030,
            Intervals.SumIntervals(new Interval[] { (0, 20), (-100_000_000, 10), (30, 40) })
        );
    }
}
