...
public class IntervalTest
{
    ...
    {
        Assert.Equal(2_000_000_000, Intervals.SumIntervals(new Interval[] { (-1_000_000_000, 1_000_000_000) }));
        Assert.Equal(100_000_030, Intervals.SumIntervals(new Interval[] { (0, 20), (-100_000_000, 10), (30, 40) }));
    }
}
